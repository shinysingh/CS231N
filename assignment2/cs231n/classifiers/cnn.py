...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        H_conv_out = 1 + (H - filter_size)
        W_conv_out = 1 + (W - filter_size)
    ...
    def loss(self, X, y=None):
        ...
        (out, hidden_fc_cache) = affine_relu_forward(out, W2, b2)
        ...
        dx, grads['W3'], grads['b3'] = affine_backward(dx, fc_cache)
        loss += 0.5 * self.reg * np.sum(np.square(self.params['W3']))
        grads['W3'] += self.reg * self.params['W3']
        # backward pass through hidden affine and relu layer
        dx, grads['W2'], grads['b2'] = affine_relu_backward(dx, hidden_fc_cache)
        loss += 0.5 * self.reg * np.sum(np.square(self.params['W2']))
        grads['W2'] += self.reg * self.params['W2']
        # backward pass through conv_relu_maxpool layer
